...
(def swagger-docs
  ["/swagger.json"
   {:get
    {:no-doc true
     :swagger {:info {:title "hop-tutorial API reference"
                      :description "The hop-tutorial API"
                      :version "1.0.0"}}
...
(defmethod ig/init-key :hop-tutorial.api/main
  ...
  (reitit.ring/ring-handler
   ...
   (reitit.ring/routes
    ...
    (reitit.ring/create-resource-handler {:path "/" :root "hop_tutorial/public"})
